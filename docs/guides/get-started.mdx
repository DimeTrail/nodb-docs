...
- Create an account with [NoDB](https://app.nodb.ai).
...
To learn more about these cofigs, see [Data Source](/docs/guides/data-source).

:::info

NoDB also provides you with $1 credit for storing your vector embedding and generating context-aware responses with ChatGPT. We'll ask for your billing information once you've exceeded your credit. See [Usage](/docs/guides/usage).
